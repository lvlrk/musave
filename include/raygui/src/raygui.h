...
RAYGUIAPI int GuiLabelButtonColor(Rectangle bounds, const char *text, const Color color);              // Label button control w/ color
...
// Label button control w/ color
int GuiLabelButtonColor(Rectangle bounds, const char *text, const Color color)
{
    GuiState state = guiState;
    bool pressed = false;
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawText(text, GetTextBounds(LABEL, bounds), GuiGetStyle(LABEL, TEXT_ALIGNMENT), color);
    //--------------------------------------------------------------------
